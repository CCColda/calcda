...
/**
     ...
     *
     * @see [Reference: Intrinsics](https://referencesource.microsoft.com/#System.Numerics/System/Numerics/Vector3_Intrinsics.cs),
     * @see [Reference: Vector3](https://referencesource.microsoft.com/#System.Numerics/System/Numerics/Vector3.cs)
     */
...
public:
	...
	//! @brief Transforms the vector to have the values of its elements' square roots
	Vector3 &selfSqrt();
     ...
     * @see [Reference](https://referencesource.microsoft.com/#System.Numerics/System/Numerics/Vector3.cs "Vector3")
     */
     ...
     * @see [Reference](https://referencesource.microsoft.com/#System.Numerics/System/Numerics/Vector3_Intrinsics.cs "Vector3 Intrinsics")
     */
	...
	template <std::size_t I>
	inline std::tuple_element_t<I, Vector3> &get()
	{
		CALCDA_IF_CONSTEXPR (I == 0)
			return x;
		else CALCDA_IF_CONSTEXPR (I == 1)
...
template <size_t I>
struct CALCDA tuple_element<I, Calcda::Vector3> {
	using type = float;
};

template <>
struct CALCDA hash<Calcda::Vector3> {
	size_t operator()(const Calcda::Vector3 &v) const noexcept
	{
		return Calcda::Internal::hash_combine(hash<float>()(v.x), hash<float>()(v.y), hash<float>()(v.z));
	}
};
} // namespace std
