...
TEST_CASE("Vector2 operations", "Vector2") {
    ...
    SECTION("addition") {
        REQUIRE(Vector2(1.0f, 2.0f) + Vector2(3.0f, 4.0f) ==
                Vector2(4.0f, 6.0f));
    }

    SECTION("subtraction") {
        REQUIRE(Vector2(1.0f, 2.0f) - Vector2(0.5f, 1.0f) ==
                Vector2(0.5f, 1.0f));
    }

    SECTION("multiplication") {
        REQUIRE(Vector2(2.0f, 2.0f) * Vector2(3.0f, 4.0f) ==
                Vector2(6.0f, 8.0f));
    }

    SECTION("division") {
        REQUIRE(Vector2(5.0f, 8.0f) / Vector2(2.5f, 4.0f) ==
                Vector2(2.0f, 2.0f));
    }
